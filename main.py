...
# Consulta SQL de exemplo para demonstrar o funcionamento do processador
EXAMPLE_QUERY = (
...
# Classe principal da aplicação Tkinter para processar consultas SQL
class QueryProcessorApp:
    # Método inicializador da classe, configura a janela principal e inicializa componentes
    ...
    # Método para construir o layout da interface gráfica
    ...
    # Método para construir a aba de resultados
    ...
    # Método para construir a aba de grafos
    ...
    # Método para construir a aba do plano de execução
    ...
    # Método para preencher o texto do esquema de metadados
    ...
    # Método para inserir a consulta de exemplo no campo de texto SQL
    def insert_example(self) -> None:
        self.sql_text.delete('1.0', 'end')
        self.sql_text.insert('1.0', EXAMPLE_QUERY)

    # Método para limpar todos os campos de texto e canvas
    ...
    # Método para processar a consulta SQL inserida pelo usuário
    ...
    # Método auxiliar para inserir texto em um widget Text
    def _put_text(self, widget: tk.Text, text: str) -> None:
        widget.delete('1.0', 'end')
        widget.insert('1.0', text)

    # Método para desenhar o grafo no canvas
...
# Bloco principal para executar o programa quando o script é chamado diretamente
